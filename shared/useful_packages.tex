...
\newtcolorbox{meeting}[4]{colframe=white, colback=white, colbacktitle=gray!10!white, 
	...
	title={\begin{tabular}{p{2.5cm}p{2.5cm}p{2.5cm}p{2.5cm}l}Meeting \arabic{meetingscounter}  &  \stepcounter{meetingscounter} \faCalendar\ #2 &  \faClockO\ #3 & \faMapMarker\ #4 & \faUsers\ #1\end{tabular}}}
